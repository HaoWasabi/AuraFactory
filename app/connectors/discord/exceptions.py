...
Typed errors enable the agent to make informed recovery decisions
instead of parsing raw error messages.
"""
...
class CommunityRequiredError(Exception):
    ...
    Carries structured context so the agent/executor can surface a recovery suggestion
    ...
    Attributes:
        ...
        channel_type:    Type of channel being created ("stage", "news", etc.).
    """
